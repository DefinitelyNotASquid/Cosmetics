package com.mith.Cosmetics.manager;
...
public class Messages {
    ...
    private final File FILE = new File("plugins/Cosmetics", "messages.properties");
    ...
    private String getStringFromBundle(String key, Object... args) {
        try {
            ...
            Bukkit.getLogger().severe("[Cosmetics] Missing message in message.properties! Message key: " + key);
            return key;
        }
    }
